      ...
      <div class="detail-content">
        <div class="detail-content-top">
          ...
          <div class="top-right">
            ...
            <div class="meta">职称：{{ detailData.zhicheng }}</div>
            <div class="price">挂号费：{{ detailData.price }}元</div>
            <div class="price">是否专家：{{ detailData.expert}}</div>
            <div class="meta">在诊时间：{{ detailData.zzsj }}</div>
            <div class="actions">
                ...
                <div class="things">
                  <div class="thing-item" v-for="item in recommendData" @click="handleDetail(item)">
                    ...
                    <div class="info-view">
                      ...
                      <span>
                        <span class="a-price">{{ item.zhicheng }}</span>&nbsp;
