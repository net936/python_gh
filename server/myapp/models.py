...
class Thing(models.Model):
    ...
    zhicheng = models.CharField(max_length=50, blank=True, null=True)  # 职称
    expert = models.CharField(max_length=2, blank=True, null=True)  # 是否专家
    zzsj = models.CharField(max_length=50, blank=True, null=True)  # 在诊时间
    mobile = models.CharField(max_length=50, blank=True, null=True)  # 医生联系方式
...
class Order(models.Model):
    ...
    receiver_name = models.CharField(max_length=20, blank=True, null=True) # 就诊人
    receiver_id = models.CharField(max_length=20, blank=True, null=True)  # 身份证
    receiver_time = models.CharField(max_length=20, blank=True, null=True) # 就诊时间
